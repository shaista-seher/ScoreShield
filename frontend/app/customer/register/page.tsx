      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full gradient-success text-white font-semibold py-3 rounded-lg hover:opacity-90 transition disabled:opacity-50"
          >
          ...
          <div className="text-center text-sm text-gray-600">
            ...
            <Link href="/customer/login" className="text-green-600 hover:text-green-700 font-medium">
              Login here
            </Link>
          </div>
